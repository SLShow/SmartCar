...
////   uint8 Key4value=0x00;
////   uint8 Key5value=0x00;
//   if(0==gpio_get(PTA12) ) 
//   {
//     DELAY_MS(50);
//     if(0==gpio_get(PTA12))
...
//   }
//     
////   KeyPort=KeyPort&(~Key0value)&(~Key1value)&(~Key2value)&(~Key3value)&(~Key4value)&(~Key5value);
//   return KeyPort;
// }
//
// void ThreeLineKeyRead(void)//读按键    /*核心代码*/
//{
//   uint8 virtualPinValue=GetPinValue();
//   uint8 ReadData=0;
//   ReadData=virtualPinValue;
//   GTrigger=ReadData;//&(ReadData^GHold);
////   GHold=ReadData;
////   GTrigger=virtualPinValue;
// }
//
//void KeyPress(uint8* g_KeyValue)
//{
//  switch(GTrigger)
//  {
//   case 0x01: *g_KeyValue=go_now;break;
//   case 0x02: *g_KeyValue=Sub_line;break;
//   case 0x04: *g_KeyValue=Add_line;break;
//   case 0x08: *g_KeyValue=Sub_1;break;
//   case 0x10: *g_KeyValue=Add_1;break;
//   case 0x20: *g_KeyValue=Add_1;break;
//   
//  default: *g_KeyValue=Null_;break;
//  }
//}
//
//void KeyRead(uint8* g_KeyValue)
// {
